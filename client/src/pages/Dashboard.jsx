...
// ⭐️ SỬA ĐỔI: Import thêm useNavigate
    ...
    <div className='h-full py-4'>
      <>
        ...
        <div className='w-full bg-white dark:bg-[#1f1f1f] my-16 p-4 rounded shadow-sm'>
          <h4 className='text-xl text-gray-500 dark:text-white font-bold mb-2'>
            Chart by Priority
          </h4>
...
const TaskTable = ({ tasks }) => {
  ...
  const TableRow = ({ task }) => {
    // ⭐️ SỬA ĐỔI: Khởi tạo hook useNavigate
    const navigate = useNavigate();

    return (
      // ⭐️ SỬA ĐỔI: Thêm sự kiện onClick và class `cursor-pointer`
      <tr
